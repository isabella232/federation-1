...
| `OVERRIDE_FROM_SELF_ERROR` | From location of field with `@override` directive is its own subgraph. | 2.0.0 |  |
| `OVERRIDE_SOURCE_HAS_OVERRIDE_ERROR` | Field which is overridden to another subgraph is also marked @override. | 2.0.0 |  |
